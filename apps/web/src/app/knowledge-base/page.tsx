...
import { Button, Card, Badge, PageSkeleton, PageHeader, Modal } from '../../components/ui';
import {
  Search, BookOpen, HelpCircle, FileText, ChevronRight,
  Plus, Pencil, Eye, Filter, X,
} from 'lucide-react';
          ...
          actions={
            canManage ? (
              <Link href="/knowledge-base/manage">
                <Button icon={<Pencil size={15} />}>Manage Articles</Button>
              </Link>
            ) : undefined
          }
        />
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              onChange={(e) => { setSelectedModule(e.target.value); setArticlePage(1); setHelpPage(1); }}
            >
            ...
            {articles.length === 0 ? (
              <Card padding="lg">
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-content-tertiary mt-1">Knowledge base articles will appear here once created.</p>
                </div>
              </Card>
            ) : (
